  ...
  $.ajax({
    ...
    success: function(response) {
      ...
      fields = lines[1].split("|");
       ...
       secondColumn += '<div class="col_half"><span itemprop="productID" class="sku_wrapper" style="font-size: 24px; font-weight: 600;">ITEM # <span class="sku">' + fields[0].replace(/\s+/g,'') + '</span></span></div><div class="col_half col_last"><input id="input-4" name="input-4" value="2.5" class="rating rating-loading"></div><div class="line"></div>';
